...
# # fmt: off
# args = argparse.ArgumentParser(prog="train", description="Training about Conversational Context Inference.")
...
def train():
    ...
    # train_dataset = CustomDataset(".json", tokenizer)
    # valid_dataset = CustomDataset(".json", tokenizer)
